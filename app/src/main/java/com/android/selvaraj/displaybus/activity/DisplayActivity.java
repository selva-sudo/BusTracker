...
import com.android.selvaraj.displaybus.directionhelpers.FetchURL;
import com.android.selvaraj.displaybus.directionhelpers.TaskLoadedCallback;
...
public class DisplayActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, TaskLoadedCallback {
    ...
    private int count = 0;
    private LatLng myPoint, busPoint;
    ...
    private void drawMarker(LatLng point) {
        ...
        if (mMarkerPoints.size() == 1) {
            ...
            if(dis >0.0) {
                tvDistance.setText(String.valueOf(dis) + " KM(s)");
            }
